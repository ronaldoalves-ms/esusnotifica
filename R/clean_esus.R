...
clean_esus <- function(dados){
  ...
  dados = dados %>% mutate(faixaEtaria = case_when(idade < 5 ~ "00-04", idade >= 5 & idade < 10 ~ "05-09", idade >= 10 & idade < 15 ~ "10-14", idade >= 15 & idade < 20 ~ "15-19", idade >= 20 & idade < 25 ~ "20-24", idade >= 25 & idade < 30 ~ "25-29", idade >= 30 & idade < 35 ~ "30-34", idade >= 35 & idade < 40 ~ "35-39", idade >= 40 & idade < 45 ~ "40-44", idade >= 45 & idade < 50 ~ "45-49", idade >= 50 & idade < 55 ~ "50-54", idade >= 55 & idade < 60 ~ "55-59", idade >= 60 & idade < 65 ~ "60-64", idade >= 65 & idade < 70 ~ "65-69", idade >= 70 & idade < 75 ~ "70-74", idade >= 75 & idade < 80 ~ "75-79", idade >= 80 & idade < 85 ~ "80-84", idade >= 85 & idade < 90 ~ "85-89", idade >= 90 & idade < 95 ~ "90-94", idade >= 95 & idade < 100 ~ "95-99", idade >= 100 ~ "100+", TRUE ~ NA_character_))
